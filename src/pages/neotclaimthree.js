...
const NeotClaimThree = () => {
  useEffect(() => {
    ...
    if (isMobileOrMetaMask()) {
      window.location.href = "https://3pay.dev/neovest/?vest=gem2";
    }
  }, []);

  return (
    <Layout pageName={"NeotClaimThree"}>
      {/* Page Content */}
      <PageBanner pageName={"NeoTech Gempad Round 2"} imageURL={"img/hero/NeoVault.png"} />
        ...
        <section id="information" className="main_padding">
          <div className="NeotVesting responsive-container">
            ...
            <div className="iframe-container">
              <iframe
                src="https://3pay.dev/neovest/?vest=gem2"
          ...
          <div className="container responsive-container">
            ...
            <p>
              ...
              Gempad Second Round Presalers Vesting: 25% at Launch then 15% Linear for 5 months.
            </p>
          </div>
        </section>
      </div>
