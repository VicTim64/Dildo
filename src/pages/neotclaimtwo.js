...
const NeotClaimTwo = () => {
  useEffect(() => {
    ...
    if (isMobileOrMetaMask()) {
      window.location.href = "https://3pay.dev/neovest/?vest=gem1";
    }
  }, []);

  return (
    <Layout pageName={"NeotClaimTwo"}>
      {/* Page Content */}
      <PageBanner pageName={"NeoTech Gempad Round 1"} imageURL={"img/hero/NeoVault.png"} />
        ...
        <section id="information" className="main_padding">
          <div className="NeotVesting responsive-container">
            ...
            <div className="iframe-container">
              <iframe
                src="https://3pay.dev/neovest/?vest=gem1"
          ...
          <div className="container responsive-container">
            ...
            <p>
              ...
              Gempad First Round Vesting: 20% at Launch then 16% Linear over 5 months.
            </p>
          </div>
        </section>
      </div>
